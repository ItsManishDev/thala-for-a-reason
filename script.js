function checkConnection() {
    ...
    if (sumOfDigits === 7) {
        displayOutput('Thala for a Reason! Sum of digits is 7! Refresh the page and try again!');
    ...
    if (numberOfLetters === 7) {
        displayOutput('Thala for a Reason! 7 letters found! Refresh the page and try again!');
        playLocalVideo('localVideoSeven');
        return;
    }
    ...
    if (numberOfWords === 7) {
        displayOutput('Thala for a Reason! 7 words found! Refresh the page and try again!');
        playLocalVideo('localVideoSeven');
        return;
    }
    ...
    if (wordplayConnection(userInput)) {
        displayOutput('Thala for a Reason! Wordplay connection to 7! Refresh the page and try again!');
        playLocalVideo('localVideoSeven');
        return;
    }

    // No connection found, play another video
    displayOutput('No connection to 7 found.Refresh the page and try again! Refresh the page and try again!');
